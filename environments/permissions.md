...
| devops/*, networking/* | infra/config + `environments/**` (networking only) | `environments/` is writable by `networking/network-engineer`; changes reviewed by `security/architect`. |
