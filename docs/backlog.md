...
| GT-43 | Hard-verifier registry: scripts/verifiers/ single-property machines gating the verdict loop (from hard-verifiers brainstorm) | security team + ci/pipeline-engineer | (next) | todo | — |
