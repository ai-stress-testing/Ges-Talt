...
| GT-73 | Pre-PR comprehension MCQ quiz (anti-slop, human-in-the-loop): WORKFLOW.md §6, owned by pm/ticket-workflow-steward — 3–5 diff-grounded MCQs (what-changed + why) before a substantial PR | pm/ticket-workflow-steward | sprint-7-26-20-27 | done | [#73](https://github.com/ai-stress-testing/Ges-Talt/issues/73) |
| GT-74 | Risk-tier the falsifier gate (owner feedback: over-triggering): falsifier reserved for critical systems (auth/API/payments/crypto/irreversible), lint/test + Playwright substitutes for lower-risk; updated falsifier charter, WORKFLOW §1, CLAUDE Routing, SessionStart hook | main session | sprint-7-26-20-27 | done | [#74](https://github.com/ai-stress-testing/Ges-Talt/issues/74) |
| GT-75 | Dedicated API-security verification (#7 + #56): security/api-security-verifier role + .claude/skills/api-hardening-review checklist (auth/BOLA, crypto/mTLS+HMAC notary, token validation & revocation, I/O hygiene, headers, rate limiting, geo scoring, canary/deception, SSRF, business-logic/concurrency, credential endpoints). Red-team-critic FAIL → 17 gaps incorporated | security/api-security-verifier + security/red-team-critic | sprint-7-26-20-27 | done | [#7](https://github.com/ai-stress-testing/Ges-Talt/issues/7), [#56](https://github.com/ai-stress-testing/Ges-Talt/issues/56) |
| GT-76 | EPIC: Automate the mechanical ceremony (introspection) — 5 stdlib helper scripts, routed to ci/pipeline-engineer + data/data-engineer | ci/pipeline-engineer | sprint-7-26-20-27 | done | [#67](https://github.com/ai-stress-testing/Ges-Talt/issues/67) |
| GT-77 | scripts/gate.py — one-command regenerate+lint+verify (7-step pipeline, failures-first, --check) | ci/pipeline-engineer | sprint-7-26-20-27 | done | [#68](https://github.com/ai-stress-testing/Ges-Talt/issues/68) |
| GT-78 | scripts/extract_text.py + setup-tools.sh — PDF->text with provisioned poppler/pdfminer; caught+fixed a BaseException crash | data/data-engineer | sprint-7-26-20-27 | done | [#69](https://github.com/ai-stress-testing/Ges-Talt/issues/69) |
| GT-79 | scripts/new_sprint_log.py — stamp dated sprint-log entry from template w/ run-manifest header | ci/pipeline-engineer | sprint-7-26-20-27 | done | [#70](https://github.com/ai-stress-testing/Ges-Talt/issues/70) |
| GT-80 | scripts/ship.py — push dev + FF main with backoff, never force-pushes | ci/pipeline-engineer | sprint-7-26-20-27 | done | [#71](https://github.com/ai-stress-testing/Ges-Talt/issues/71) |
| GT-81 | scripts/backlog.py — add row / flip status, byte-precise | ci/pipeline-engineer | sprint-7-26-20-27 | done | [#72](https://github.com/ai-stress-testing/Ges-Talt/issues/72) |
