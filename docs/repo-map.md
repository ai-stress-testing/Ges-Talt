...
| [`legal`](agents/legal/) | 4 | Legal Team |
| [`logicians`](agents/logicians/) | 6 | Logicians |
| [`mx`](agents/mx/) | 2 | MX — Multi-Experience |
| [`networking`](agents/networking/) | 2 | Networking Team |
| [`pm`](agents/pm/) | 7 | PM Team |
| [`security`](agents/security/) | 17 | Security Team |
...
| File | Purpose |
|---|---|
| `README.md` | Environments (the hands) |
| `THREAT-MODEL.md` | Threat model — the agent org itself |
| `mcp-scoping.md` | MCP scoping |
| `network-policy.md` | Network policy — egress allowlists |
| `permissions.md` | Write permissions — path scoping |
| `secrets.md` | Secrets |
| `session-lifecycle.md` | Session lifecycle — proactive reaping |
...
| `docs/sprint-7-26-20-27/` | 3 file(s) |
