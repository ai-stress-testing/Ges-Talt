...
**Handoffs**: orchestration → `devops/kubernetes-engineer`; registry
lifecycle → `devops/lifecycle-manager`; git-as-truth manifests →
`devops/gitops-engineer`; vuln gate → `security/appsec-engineer`.
